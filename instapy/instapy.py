...
class InstaPy:
    ...
    def like_by_locations(self,
        ...
        # sc added
        self.session_total_liked = self.session_total_liked + liked_img
    ...
    def like_by_users(self, usernames, amount=10, randomize=False, media=None):
        ...
        # sc added
        self.session_total_liked = self.session_total_liked + total_liked_img
    ...
    def end(self):
        ...
        self.logger.info('Session started - {}'.format(
            self.start_time.strftime('%Y-%m-%d %H:%M:%S')))
        self.logger.info('Total Liked: {}'.format(self.session_total_liked))
